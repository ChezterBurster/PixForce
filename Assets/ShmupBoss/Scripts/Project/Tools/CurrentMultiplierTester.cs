...
namespace ShmupBoss
{
    ...
    {
        [HelpBox("This tool is just to show the currently used multiplier data, this is helpful for debugging " +
        ...
        [HelpBox("Do no adjust, just observe the data change after hitting play.")]
